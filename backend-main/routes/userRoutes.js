...
router.post("/loan/assign", authMiddleware, adminMiddleware, (req, res) => assignLoan(req, res, io, userSockets));
router.post("/refund", authMiddleware, adminMiddleware, (req, res) => refundUser(req, res, io, userSockets));
router.post("/repay-loan", authMiddleware, adminMiddleware, repayLoan);
router.post("/loan/repay", authMiddleware, adminMiddleware, (req, res) => refundUser(req, res, io, userSockets));
