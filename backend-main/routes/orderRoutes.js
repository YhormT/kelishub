...
const templatePath = path.join(
  __dirname,
  "../uploads/order_upload_template.xlsx",
);
...
router.post(
  ...
  authMiddleware,
  upload.single("file"),
  orderController.uploadExcelOrders,
);
...
router.get(
  ...
  authMiddleware,
  orderController.downloadSimplifiedTemplate,
);
router.post(
  "/upload-simplified",
  authMiddleware,
  upload.single("file"),
  orderController.uploadSimplifiedExcelOrders,
);
...
router.put(
  ...
  authMiddleware,
  adminMiddleware,
  orderController.processOrderController,
);
...
router.get(
  ...
  authMiddleware,
  adminMiddleware,
  orderController.getOrderTracker,
);
router.post(
  "/admin/resolve-alert",
  authMiddleware,
  adminMiddleware,
  orderController.resolveAlert,
);
...
router.get(
  ...
  authMiddleware,
  adminMiddleware,
  orderController.downloadOrdersForExcel,
);

// Order Batch (Order Files) routes - must be before /admin/:userId
router.get(
  "/admin/batches/pending-counts",
  authMiddleware,
  adminMiddleware,
...
router.get(
  ...
  authMiddleware,
  adminMiddleware,
  orderController.getAllBatches,
);
router.get(
  "/admin/batches/:batchId",
  authMiddleware,
  adminMiddleware,
  orderController.getBatchById,
);
router.put(
  "/admin/batches/:batchId/status",
  authMiddleware,
  adminMiddleware,
  orderController.updateBatchStatus,
);
router.put(
  "/admin/batches/:batchId/items/:itemId/status",
  authMiddleware,
  adminMiddleware,
  orderController.updateBatchOrderItemStatus,
);
router.get(
  "/admin/batches/:batchId/download",
  authMiddleware,
  adminMiddleware,
  orderController.downloadBatch,
);
...
router.get(
  ...
  authMiddleware,
  orderController.getUserCompletedOrdersController,
);
...
router.put(
  ...
  authMiddleware,
  adminMiddleware,
  orderController.updateOrderItemsStatus,
);
router.put(
  "/items/:itemId/status",
  authMiddleware,
  adminMiddleware,
  orderController.updateSingleOrderItemStatus,
);
...
router.post(
  "/admin/batch-complete",
  authMiddleware,
  adminMiddleware,
  orderController.batchCompleteProcessing,
);
